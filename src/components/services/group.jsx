  ...
  return (
    <div
      ...
      className={classNames(
        ...
        layout?.style === "row" ? "basis-full" : maxGroupColumns ? `basis-full md:basis-1/2 lg:basis-1/3 xl:basis-1/4 3xl:basis-1/${maxGroupColumns}` : "basis-full md:basis-1/2 lg:basis-1/3 xl:basis-1/4",
        groupPadding,
        isSubgroup ? "subgroup" : "",
      )}
    >
